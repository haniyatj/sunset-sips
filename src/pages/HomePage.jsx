    ...
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        <div className="flex items-center justify-center flex-col h-120 bg-white  mb-14">
          <img src="/assets/images/sunsetlogo.png" className="w-120 h-80" />
        </div>

        {/* Background overlay for blurred effect */}
        {isModalOpen && (
          <div className="fixed inset-0 z-40 bg-opacity-50 backdrop-filter backdrop-blur-lg"></div>
        )}
      ...
      {/* Render the ProductModal when selectedProduct is not null */}
      {selectedProduct && (
